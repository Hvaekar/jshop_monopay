...
define('_JSHOP_MONOPAY_CHECK_RETURN_DESC',"'Так' - замовлення буде створене як незакінчене до моменту підтвердження оплати, статуси мінятися не будуть, повернення на сайт приведе на сторінку підтвердження замовлення. 'Ні' - статуси будуть мінятися починаючи з процесу підтвердження оплати клієнтом в банку, повернення на сайт в будь-якому випадку завершить замовлення і клієнтові видасть кінцеву сторінку 'Дякую...'");
...
define('_JSHOP_MONOPAY_SUCCESS_BTN',"Підтвердити і оплатити");
